<script context="module" lang="ts">
    export const backendAddress: string = "http://localhost:8000"// window.location.href.slice(0, window.location.href.length - window.location.pathname.length); //"http://192.168.9.129:8000", //window.location.href.slice(0, window.location.href.length - window.location.pathname.length);

...
from open_precision.core.interfaces.sensor_types import global_positioning_system, absolute_orientation_sensor
...
class GpsCompassPositionBuilder(PositionBuilder):
    ...
    def __init__(self, sensor_manager: PluginManager, config_manager: ConfigManager):
        ...
        self.gps_class = global_positioning_system
        self.aos_class = absolute_orientation_sensor

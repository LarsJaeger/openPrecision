...
class Path(DataModelBase, PersistenceModelBase):
    ...
    priority: Mapped[int] = mapped_column(init=True, default=None, nullable=True)
    ...
    course_id: Mapped[int] = mapped_column(ForeignKey("Courses.id"), init=True, default=None)
    course: Mapped[Course] = relationship(default=None, init=True, uselist=False, back_populates='_paths')
